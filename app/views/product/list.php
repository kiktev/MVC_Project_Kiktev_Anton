...
<select name='sort'>
    <option <?php echo $this->get('selected_item') === 'price_ASC' ? 'selected' : '';?> value="price_ASC">від дешевших до дорожчих</option>
    <option <?php echo $this->get('selected_item') === 'price_DESC' ? 'selected' : '';?> value="price_DESC">від дорожчих до дешевших</option>
	<option <?php echo $this->get('selected_item') === 'qty_ASC' ? 'selected' : '';?> value="qty_ASC">по зростанню кількості</option>
    <option <?php echo $this->get('selected_item') === 'qty_DESC' ? 'selected' : '';?> value="qty_DESC">по спаданню кількості</option>
</select>
